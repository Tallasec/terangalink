                ...
                <div className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr]">
                    <div>
                        <h2 className="max-w-[460px] text-[32px] font-semibold leading-[40px] tracking-[-0.01em] text-[#00343a]">
                            S&apos;installer ne devrait pas Ãªtre une Ã©preuve solitaire.
                        </h2>
                        ...
                        <div className="mt-10 space-y-8">
                            <div className="flex gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="mt-2 max-w-lg text-[16px] font-normal leading-[24px] text-[#40484a]">
                                        Renseignez votre universitÃ©, votre ville et ce que vous
                                        recherchez.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="mt-2 max-w-lg text-[16px] font-normal leading-[24px] text-[#40484a]">
                                        ...
                                        partenaires de rÃ©vision prÃ¨s de vous.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-4">
                                ...
                                <div>
                                    <h3 className="text-[20px] font-medium leading-[28px] text-[#00343a]">
                                        RÃ©ussissez ensemble
                                    </h3>
                                    <p className="mt-2 max-w-lg text-[16px] font-normal leading-[24px] text-[#40484a]">
                                        AccÃ©dez Ã  un support continu 24/7 et Ã  des conseils
                                        administratifs.
                                    </p>
                                </div>
                            </div>
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-6">
                        <div className="col-span-1 min-h-[170px] rounded-2xl bg-white p-6 soft-elevation">
                        ...
                        <div className="col-span-1 min-h-[170px] rounded-2xl bg-[#00343a] p-6 text-white soft-elevation">
                            <div className="flex h-full flex-col items-center justify-center text-center">
