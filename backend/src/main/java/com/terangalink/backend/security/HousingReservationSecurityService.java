...
@Service("housingReservationSecurityService")
public class HousingReservationSecurityService {

    private final HousingRepository housingRepository;

    public HousingReservationSecurityService(HousingRepository housingRepository) {
        this.housingRepository = housingRepository;
    }

    public boolean canViewHousingReservations(Long housingId) {
