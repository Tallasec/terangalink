...
@Service("housingSecurityService")
public class HousingSecurityService {

    private final HousingRepository housingRepository;

    public HousingSecurityService(HousingRepository housingRepository) {
        this.housingRepository = housingRepository;
    }

    public boolean canAccessHousing(Long housingId) {
